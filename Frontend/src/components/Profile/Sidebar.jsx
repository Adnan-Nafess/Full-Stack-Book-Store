  ...
  return (
    <div className="bg-zinc-800 p-4 rounded flex flex-col items-center justify-between h-auto lg:h-[100%]">
        <div className="flex items-center justify-center flex-col">
              <img className="h-[12vh]" src={data.avatar} alt="logo" />
      ...
      { role === "user" &&  <div className="w-full flex-col items-center justify-center hidden md:flex">
            <Link
              to="/profile"
      ...
      { role === "admin" &&  <div className="w-full flex-col items-center justify-center hidden md:flex">
        ...
        <button 
          className="bg-zinc-900 w-3/6 md:w-full mt-4 md:mt-0 text-white font-semibold flex items-center justify-center py-2 rounded hover:bg-white hover:text-zinc-900 transition-all duration-300"
          onClick={() => {
